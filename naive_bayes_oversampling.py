...
oversampled_features = np.concatenate([features] + [features[dup_indices]]*20, axis=0)
oversampled_labels = np.concatenate([encoded_labels] + [encoded_labels[dup_indices]]*20, axis=0)
